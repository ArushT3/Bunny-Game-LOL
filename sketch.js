...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   rope = new Rope(8,{x:60,y:90});
   rope2 = new Rope(8,{x:430,y:90});
  ...
  //balloon
  balloon_blower = createImg('balloon2.png');
  balloon_blower. position(185,400)
  balloon_blower.size(120,120)
  balloon_blower.mouseClicked(blow);


  //star display
  star_display = createSprite(80,30,30,30)
  ...
  star = createSprite(280,50,20,20);
  star.addImage(star_image);
  star.scale = 0.02;


  star2 = createSprite(50,340,20,20);
...
function blow() 
{
Matter.Body.applyForce(fruit, {x:0,y:0}, {x:0, y:-0.065})
}